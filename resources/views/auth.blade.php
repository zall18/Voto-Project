...
<head>
    ...
    <title>Voto | Login Page</title><!--begin::Primary Meta Tags-->
    ...
    <link rel="stylesheet" href="{{ asset('AdminAssets/css/adminlte.css') }}"><!--end::Required Plugin(AdminLTE)-->
    <link rel="icon" type="image/x-icon" href="{{ asset('LogoAsset/LogoSmall.png') }}" />
</head> <!--end::Head--> <!--begin::Body-->

<body class="login-page bg-black">
    <div class="login-box">
        <div class="login-logo"><img src="{{ asset('LogoAsset/Logo Voto.png') }}" alt=""></div> <!-- /.login-logo -->
        <div class="card">
    ...
    <script src="{{ asset('AdminAssets/js/adminlte.js') }}"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    <script>
